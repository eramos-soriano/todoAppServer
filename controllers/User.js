...
// set up funtion for user to register
export const register = async (req, res) => {
    try {
        
        // using req.body object to recieve data through POST and PUT
        ...
        // finds one document from email
        let user = await User.findOne({ email });

        // if a user exist, output error
        if(user) {
            return res
            .status(400)
        ...
        // give out six digit # (calculated from DevTools)
        ...
        // 201 status code - request was successful
        sendToken(
            res,
            user,
            201,
...
export const login = async (req, res) => {
    ...
    // 200 status code - request has succeeded
